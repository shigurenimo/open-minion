...
export declare abstract class MinionWebSocketConnection {
    abstract send(data: string): void;
    abstract close(code?: number): void;
}
export declare abstract class MinionWebSocketFactory {
    /** Opens a connection. Returns an Error (instead of throwing) when the socket can't even be constructed, e.g. a malformed URL. */
    abstract connect(url: string, handlers: MinionWebSocketHandlers): MinionWebSocketConnection | Error;
}
